...
The quote form uses a hosted form endpoint. The submit state distinguishes an accepted request from a validation or delivery error, and the owner receives the recorded enquiry through the configured business channel.
